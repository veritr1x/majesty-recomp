...
recovered by hand. No such set exists for "MajestyHD - Old.exe", so this script imports
...
into ignored analysis/decompiled/MajestyHD - Old.exe with the kit's ExportProgram.java.
Run tools/setup.py --install ... --link-only first. The export of a 2.5 MB
...
def main():
    ...
    listings = cfg["listings_path"]            # analysis/decompiled/MajestyHD - Old.exe
